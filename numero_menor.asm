...
msg4: .asciiz "El numero menor es " #Declara la variable msg4 y la inicializa
...
main:
    ...
    ble $t1, $t2, menor  #Si el numero 1 es menor que el numero 2, salta al label menor
    move $t4, $t2        #Sino (numero 2 menor) guarda el numero 2 en t4
    j parte2 	         #Salta al label parte2
    
menor: #Parte del codigo que se ejecuta si numero 1 es menor que el numero 2
    move $t4, $t1        #Carga el numero 1 en t4

parte2: #Parte del codigo que sigue al primer condicional
    #Comparamos el numero menor (de entre los numeros 1 y 2) con el numero 3
    ble $t4,$t3,final    #Si el numero en t4 es menor que el numero 3, salta al label final
    move $t4, $t3	 #Sino (numero 3 es menor) guarda el numero 3 en t4
    j final              #Salta al label final
    
final: #Parte final del codigo
    #Imprimimos el numero menor calculado
    li $v0, 4            #Codigo de servicio 4 para imprimir una cadena
    la $a0, msg4         #Carga la direccion de la cadena en $a0
    syscall 
    
    move $a0, $t4        #Carga el número menor en $a0
